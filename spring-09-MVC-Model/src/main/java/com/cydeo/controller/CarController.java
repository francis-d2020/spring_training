...
public class CarController {
    ...
    //the request param must match with the param in the url
    @RequestMapping("/info")
    ...
    @RequestMapping("/info2")//if no param is entered then make=kia as default
    ...
    @RequestMapping("/info/{make}/{year}")//path variables makes matches based on position
    //so 2015/honda will fail
