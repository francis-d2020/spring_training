...
public interface EmployeeRepository extends JpaRepository<Employee,Integer> {
    ...
    //we annotate with @query when it is not a derived query but jpql/sql.
    ...
    //Not Equal
    // this query is with one parameter and by using positional parameter we write ?1 to
    //specify the position of the value in the method parameters.
    ...
    //Native Query
    //pure sql, the data is based on the table(employees) and table field(salary).
    //value and native query specify that this is not jpql but native query.
